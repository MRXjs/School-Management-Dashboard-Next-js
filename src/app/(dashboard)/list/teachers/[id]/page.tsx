                ...
                <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <div className="bg-mrxSky py-6 px-4 rounded-md flex-1 flex gap-4">
                        ...
                        <div className="w-1/3">
                            <Image
                                src={
                                    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQK8qjbcWIhlL8XHMdGnUvmEgiO0ZmC_vH-J2IrGNmmYiWLhJzy3WRuF3vbUkS-xkNnBAQ&usqp=CAU'
                                }
                                alt=""
                                width={144}
                                height={144}
                        ...
                        <div className="w-2/3 flex flex-col justify-between gap-4">
                            <h1 className="text-xl font-semibold">Azraa Sirajudeen</h1>
                            ...
                            <div className=" flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                                ...
                                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                                    ...
                                    <span>September 06 1997</span>
                                </div>
                                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                                    <Image src={'/mail.png'} alt="" width={14} height={14} />
                                    <span>azraasirajudeen@gmial.com</span>
                                </div>
                                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                                    <Image src={'/phone.png'} alt="" width={14} height={14} />
                                    <span>+94 449955798</span>
                                </div>
                            </div>
                        </div>
                    </div>
